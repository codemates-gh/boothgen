  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="p-8 space-y-8">
        ...
        <PlatformSettings initial={{ message_retention_months: settingsMap.message_retention_months ?? '12', gallery_expire_days: settingsMap.gallery_expire_days ?? '30', gallery_delete_days: settingsMap.gallery_delete_days ?? '30', stripe_price_monthly_id: settingsMap.stripe_price_monthly_id ?? '', price_display_monthly: settingsMap.price_display_monthly ?? '', commission_percentage: settingsMap.commission_percentage ?? '1.5', support_email: settingsMap.support_email ?? '', chatbot_enabled: settingsMap.chatbot_enabled !== 'false', early_adopter_cap: settingsMap.early_adopter_cap ?? '50', terms_content: settingsMap.terms_content ?? '', privacy_content: settingsMap.privacy_content ?? '' }} proSubscriberCount={proSubscriberCount} />
